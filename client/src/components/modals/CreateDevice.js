        ...
        <Modal
            ...
            <Modal.Body>
                <Form>
                    ...
                    <hr/>
                    <Button variant={"outline-dark"} onClick={addInfo}>Додати новий параметр</Button>
                    {info.map(i =>
                        <Row className="mt-3" key={i.number}>
                            <Col md={4}>
                                <Form.Control value={i.title} onChange={(e) => changeInfo('title', e.target.value, i.number)} placeholder="Введіть назву параметру" />
                            </Col>
                            <Col md={4}>
                                <Form.Control value={i.description} onChange={(e) => changeInfo('description', e.target.value, i.number)} placeholder="Введіть опис параметру" />
                            </Col>
                            <Col md={4}>
